 ...
 */
TOML_EXTERN toml_datum_t toml_seek(toml_datum_t table, const char *multipart_key);
 ...
 * or a TOML_UNKNOWN otherwise. (
 */
static inline toml_datum_t toml_table_find(toml_datum_t table, const char *key) { return toml_get(table, key); }
 ...
 *         override
 */
TOML_EXTERN toml_result_t toml_merge(const toml_result_t *r1, const toml_result_t *r2);
